...
The DAO is injected into the [hotspot=28-128 file=2]`finish/backendServices/src/main/java/io/openliberty/guides/event/resources/EventResource.java`
class and used to access and persist data. The [hotspot=39 file=2]i`@Transactional` annotation is used in the
