...
EntityManager that will be obtained by the application through injection. This means, that the lifecycle
of the EntityManager will be managed transparently by the Java EE container.
