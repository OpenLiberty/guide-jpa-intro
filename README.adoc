...
The [hotspot=persistence-file file=0]`persistence.xml` file is a configuration file that defines a persistence unit. The
...
[source, Java, linenums, role='code_column hide_tags=copyright']
----
include::finish/backendServices/src/test/java/it/io/openliberty/guides/event/EventEntityTest.java[]
----
