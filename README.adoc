...
In your dev mode console for the `backendServices` microservice, type `r` and press `enter/return` key to restart the Liberty instance for picking up the Derby libraries.
