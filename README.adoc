...
The DAO is injected into the [hotspot=28-128 file=2]`finish/backendServices/src/main/java/io/openliberty/guides/event/`
[hotspot=28-128 file=2]`resources/EventResource.java`
