...
that are displayed in the `target/liberty/wlp/usr/servers/defaultServer/logs/trace.log` file. To learn more, see the http://www.eclipse.org/eclipselink/documentation/2.5/jpa/extensions/p_logging_level.htm[
...
In order to use the entity manager at runtime, it must be injected into our CDI bean through the
