...
it is injected into the `src/main/java/io/openliberty/resources/EventResource.java` file to provide
the `EventResource` class with a way to persist and access data.
