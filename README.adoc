...
An implementation of the JPA specification is referred to as a persistence provider. In this guide you will 
use EclipseLink as the persistence provider because it is one the implementations shipped with Liberty.
...
and will be removed from the database upon transaction commit. 
