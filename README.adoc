...
the `EventService` class with a way access to the stored data.
...
Create the `EventEntityTest` test class in the `finish/src/test/java/it/io/openliberty/guides/event/EventEntityTest.java` 
file:
