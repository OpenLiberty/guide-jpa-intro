...
you will use a container-managed entity manager that is injected into the DAO, placing the 
burden of opening and closing the entity manager on the application server. 
