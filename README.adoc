...
see the https://db.apache.org/derby/papers/DerbyTut/embedded_intro.html[official website.]
...
Here is a break down of the new annotations:
...
The following properties are used for creating the database tables. 
