...
```
cd finish
mvnw.cmd -pl frontendUI liberty:run
```
--
...
```
cd finish
mvnw.cmd -pl backendServices liberty:run
```
--
...
[role='command']
```
mvnw.cmd -pl backendServices liberty:stop
mvnw.cmd -pl backendServices liberty:run
```
--
...
[role='command']
```
mvnw.cmd -pl frontendUI liberty:stop
mvnw.cmd -pl backendServices liberty:stop
```
--
...
[role='command']
```
mvnw.cmd -pl frontendUI liberty:dev
```
--
...
[role='command']
```
mvnw.cmd -pl backendServices liberty:dev
```
--
