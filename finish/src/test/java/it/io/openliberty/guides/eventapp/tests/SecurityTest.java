...
public class SecurityTest {
  ...
  public static final String EVENTS_URL = "http://localhost:9080/event/events";
  public static final String USERS_URL = "http://localhost:9080/event/users";
  public static final String SOCCER_EVENT_URL = "http://localhost:9080/event/events/soccer";
  ...
  public void setup() {
    ...
    loginForm.put("username", "bob");
    loginForm.put("password", "pwd");
  }
