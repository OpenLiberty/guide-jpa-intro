...
public class EventBean {
   ...
   */
  public static List<User> retrieveUserList(int eventId) {
  ...
  public Event retrieveSelectedEvent() {
    return ServiceUtil.retrieveEventById(selectedId);
  }
   ...
   */
  private void addErrorMessage(ComponentSystemEvent event,
      String errorMessage) {
   ...
   */
  private UIInput getUnitOfTimeOptions(ComponentSystemEvent event,
      String unit) {
   ...
   */
  private void allowSubmission(ComponentSystemEvent event,
